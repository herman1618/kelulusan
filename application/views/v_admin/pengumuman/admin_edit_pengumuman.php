              ...
              <div class='x_panel'>
                <div class='x_title'>
                  ...
                  <div class='x_content'>
                    ...
                    <form class='form-horizontal form-label-left' method="post" enctype="multipart/form-data" action="<?php echo base_url().'pengumuman/update/'.$id?>">
                   <input type="hidden" name="id" value="<?php echo $id;?>">
                   <input type="hidden" name="gambar" value="<?php echo  base_url().'image/'.$gambar?>">

                      <div class='item form-group'>
                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='tanggal'>Tanggal <span class='required'>*</span>
                        </label>
                        <div class='col-md-9 col-sm-6 col-xs-12'>
                          <input id='tanggal' class='form-control col-md-7 col-xs-12' name='tanggal' required='required' type='text' value="<?php echo $tanggal; ?>" disabled>
                        </div>
                      </div>
                      <div class='item form-group'>
                        ...
                        <div class='col-md-9 col-sm-6 col-xs-12'>
                          <input  id='judul' name='judul' required='required' class='form-control col-md-7 col-xs-12' value="<?php echo $judul; ?>">
                        </div>
                      </div>
                      <div class='item form-group'>
                        ...
                        <div class='col-md-9 col-sm-6 col-xs-12'>
                            <textarea  id='editor' name='konten' required='required' ><?php echo $isi; ?></textarea>
                        </div>
                      </div>
                      <div class='item form-group'>
                          ...
                          <input type="file" accept="image/*" name="foto" class="form-control" id="foto">
                            <div id="image-holder">
                                   <?php
                                    ...
                                    {
                                      echo "<img src='".base_url()."/images/$gambar'?rand='".rand()."' alt=''>";
                                    }?>
                                </div>
                                <script>
                      ...
                      <div class='form-group'>
                        <div class='col-md-6 col-md-offset-3'><input onclick="change_url()" type="submit" class="btn btn-primary" value="Save" name="<?php echo isset($_GET['id'])?'update':'save'; ?>">
                        </div>
                      </div>
                    </form>
                  </div>
